        ...
        <div className="p-8 space-y-8">
          <div className="text-center space-y-4">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Everything you need to know about fuellfit's €15 welcome bonus,
              our partner network, and how to maximize your fuel savings across
              Europe.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-white p-4 rounded-xl">
                ...
                <div className="text-sm text-gray-700">
                  Link your European bank card + Make first €20+ purchase
                </div>
              </div>
              <div className="bg-white p-4 rounded-xl">
                ...
                <div className="text-sm text-gray-700">
                  Instantly credited after qualifying purchase
                </div>
              </div>
              <div className="bg-white p-4 rounded-xl">
                ...
                <div className="text-sm text-gray-700">
                  Any of 15,200+ partner stations across Europe
                </div>
              </div>
              <div className="bg-white p-4 rounded-xl">
          ...
          <div className="bg-black text-white rounded-2xl p-8">
            ...
            <p className="text-center text-gray-300 mb-8 text-lg">
              fuellfit works with Europe's leading fuel brands at 15,200+
              locations
            </p>
            ...
            <div className="text-center mt-8">
              <p className="text-gray-300 text-sm">
                Plus hundreds of independent stations across 30 European
                countries
              </p>
            </div>
          </div>
          ...
          <div className="text-center text-gray-500 text-sm">
            <p>
              Need more help? Contact our 24/7 multilingual support team through
              the app
            </p>
          </div>
        </div>
